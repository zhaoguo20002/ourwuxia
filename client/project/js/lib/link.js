...
(function() {
	...
	var _events = {
		...
		getOffsetX: function(e) {
			return e.offsetX || 
			((e.targetTouches && e.targetTouches[0]) ? (e.targetTouches[0].clientX - _events.getCanvasDom().offsetLeft) : (e.clientX - _events.getCanvasDom().offsetLeft)) || 0;
		},
		/**
		 * 换算y坐标
		 * @param {object} e
		...
		getOffsetY: function(e) {
			return e.offsetY || 
			((e.targetTouches && e.targetTouches[0]) ? (e.targetTouches[0].clientY - _events.getCanvasDom().offsetTop) : (e.clientY - _events.getCanvasDom().offsetTop)) || 0;
		},
		/**
		 * 按下键盘
		 * @param {Object} event
